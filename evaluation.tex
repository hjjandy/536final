...
we have $3$ types of nodes: $GN$, whose distance is $1$ and get good service from server; $MN$,
...
relationship follows a convex shape curve, the overall throughput of one $GN$ and two $BN$ is better
